...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (file_exists($wishlist_data_file)) {
        echo "Вишлист с таким идентификатором уже существует!";
    } else {
        ...
        echo "Вишлист успешно создан! Перейдите по ссылке: <a href='wishlist.php?id={$wishlist_id}'>http://localhost/m_wishlist/wishlist.php?id={$wishlist_id}</a>";
    }
}
?>